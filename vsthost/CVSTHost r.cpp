...
AEffect *(*pMain)(long (CVSTHost::*audioMaster)(AEffect *effect,
                                  long opcode,
                                  long index,
                                  long value,
                                  void *ptr,
...
if (hModule)                            /* if there, get its main() function */
  pMain = (AEffect * (*)(long (CVSTHost::*)(AEffect *,long,long,long,void *,float)))
...
if (pMain)                              /* initialize effect                 */
 /* pEffect = pMain(
  reinterpret_cast<long (*)(AEffect *effect,long opcode,long index,long value,void *ptr,float opt) >
   
    (pHost->AudioMasterCallback));*/
    //long (__cdecl CVSTHost::*)(AEffect *,long,long,long,void *,float)

    pEffect = pMain((audioMasterCallback)pHost->AudioMasterCallback);
...
long VSTCALLBACK CVSTHost::AudioMasterCallback(AEffect *effect,long opcode,
