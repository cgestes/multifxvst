...
class CGratomaticDlg : public CDialog
{
	DECLARE_DYNAMIC(CGratomaticDlg)

public:
  //## CONSTRUCTEUR ET INITIALISATION
	CGratomaticDlg(CWnd* pParent = NULL);   // constructeur standard
